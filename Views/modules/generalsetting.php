                                ...
                                <form action="" name="formulario" id="formulario" method="POST">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                            ...
                                            <input class="form-control form-control-sm" type="hidden" name="id_negocio"
                                                id="id_negocio">
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="ndocumento"
                                                placeholder="RUC" id="ndocumento" required>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                        ...
                                        <div class="form-group col-lg-12 col-md-12 col-xs-12">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="direccion"
                                                id="direccion" maxlength="256" placeholder="Dirección" required>
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                            <label for="pais">Pais:</label>
                                            <input class="form-control form-control-sm" type="text" name="pais"
                                                id="pais">
                                        </div>
                                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                            <label for="telefono">Telefono(*):</label>
                                            <input class="form-control form-control-sm" type="text" name="telefono"
                                        ...
                                        <div class="form-group col-lg-6 col-md-6 col-xs-12">
                                            ...
                                            <input class="form-control form-control-sm" type="text" name="ciudad"
                                                id="ciudad">
                                        </div>
                                        <div class="form-group col-lg-12 col-md-12 col-xs-12">
                                        ...
                                        <div class="form-group col-lg-3 col-md-3 col-xs-12">
                                            ...
                                            <input class="form-control form-control-sm" type="text"
                                                name="nombre_impuesto" id="nombre_impuesto" placeholder="IVA - IGV">
                                        </div>
                                        <div class="form-group col-lg-3 col-md-3 col-xs-12">
                                            <label for="monto_impuesto">Cantidad (%):</label>
                                            <input class="form-control form-control-sm" type="text"
                                                name="monto_impuesto" id="monto_impuesto">
                                        </div>
                                        <div class="form-group col-lg-3 col-md-3 col-xs-12">
                                            <label for="moneda">Moneda:</label>
                                            <input class="form-control form-control-sm" type="text" name="moneda"
                                                id="moneda" placeholder="$">
                                        </div>
                                        <div class="form-group col-lg-3 col-md-3 col-xs-12">
                                            <label for="simbolo">Simbolo:</label>
                                            <input class="form-control form-control-sm" type="text" name="simbolo"
                                                id="simbolo" placeholder="s/ - $">
                                        </div>
