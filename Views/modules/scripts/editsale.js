...
function url_get() {
	...
	let idventa = query_string.get("id");
	mostrar(idventa);
}
...
function agregarDetalle(
	...
	if (idarticulo != "") {
		...
		var fila =
			...
			articulo +
			'<td class="col-xs-1"><input class="form-control form-control-sm" style="width : 70px;" type="number" min="1" max="' +
			stock +
			...
			numero_cantidad +
			'"></td>' +
			'<td class="col-xs-1"><input class="form-control form-control-sm" style="width : 70px;" type="number" min="1" step="0.01" onchange="modificarSubtotales()" name="precio_venta[]" id="precio_venta[]" value="' +
			precio_venta +
			'"></td>' +
			'<td class="col-xs-1"><input class="form-control form-control-sm" style="width : 70px;" type="number" min="0" step="0.01" onchange="modificarSubtotales()" name="descuento[]" value="' +
			descuento +
			'"></td>' +
