...
function eliminar(idpersona) {
  ...
  $.post(
    "Controllers/Person.php?op=mostrarCompras",
    { idpersona: idpersona },
    function (e) {
      data = JSON.parse(e);
      //  console.log(data.cantidadCompras);
      if (parseInt(data.cantidadCompras) > 0) {
        Swal.fire({
          title: "Error",
          text: "Este proveedor tiene ingresos registrados",
          icon: "error",
        });
      } else {
        Swal.fire({
