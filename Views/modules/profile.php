                    ...
                    <div class="card-header text-center">
                        <div class="">
                            <img alt="image" src="Assets/img/users/<?php echo $_SESSION['imagen']; ?>"
                                class="rounded-circle" width="80" height="100">
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="tab-content tab-bordered" id="myTab3Content">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12">
                                                ...
                                                <textarea class="form-control summernote-simple" name="descripcion"
                                        ...
                                        <div class="row">
                                            <div class="form-group col-12">
                                                ...
                                                <textarea class="form-control summernote-simple" name="biografia"
                          ...
                          <input class="form-control filestyle" type="file" name="imagen" id="imagen" data-buttonText="Buscar..." data-buttonName="btn-success" data-iconName="fa fa-folder-open" data-placeholder="Selecciona un imagen">
